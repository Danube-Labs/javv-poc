...
/**
 * The javv stroke-icon set — paths ported VERBATIM from the v4 prototype's `Icon` component
 * (DESIGN_SYSTEM §5; fidelity is the point — don't swap in a generic icon font). 1.8 stroke,
 * round caps, 24 viewBox, `currentColor`.
 */
const PATHS = {
  ...
  database:
    'M12 2c4.4 0 8 1.3 8 3v14c0 1.7-3.6 3-8 3s-8-1.3-8-3V5c0-1.7 3.6-3 8-3zM4 5c0 1.7 3.6 3 8 3s8-1.3 8-3M4 12c0 1.7 3.6 3 8 3s8-1.3 8-3',
  users:
    'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 11a4 4 0 100-8 4 4 0 000 8zM23 21v-2a4 4 0 00-3-3.87M16 3.13A4 4 0 0116 11',
